...
class Crypt {
    ...
    companion object {
        ...
        private const val IV_LEN_BITS = 96 // 12byte

        private const  val SYMMETRIC_KEY_LEN_BITS = 128 // 16 byte

        private const val GCM_TAG_SIZE_BITS = 128 // 16 byte
        ...
        * createSymetric Key
        ...
        fun generateAsymmetricKey(context: Context):Status {
           ...
           val keyPair = try {
                ...
                e.printStackTrace()
                return Status.error("security_keys_create_failed")
            }

            //Log.e("PRIVATE_KEY",generator.genKeyPair().toString())

            return Status.success(data = keyPair)
        }//end fn
        ...
        private fun RSAUnwrapKey(
            ...
            if (keyPair == null) {
                return Status.error("data_decryption_error")
            }
            ...
            val encryptedDataBytes = when(data){
                ...
                else -> return Status.error("unknown_encrypted_data")
            }
            ...
            val result = try {
                ...
                Status.success(data = unwrapedKey)
            }catch(e: Exception){
        ...
        private fun getDecryptedAppKey(context: Context,
                               createIfNoKey: Boolean? = false): Status{
            ...
            if(encryptedKey.isNullOrEmpty()){
                ...
                decryptedKey = decryptKeyStatus.getData<SecretKey>()!!

            }//end if

            return Status.success(data = decryptedKey)
        ...
        * encrypt
        ...
        fun decrypt(context: Context,data: String): Status {
            ...
            if(dataParts == null){
                return Status.error("encrypted_data_part_extract_error")
            }
           ...
           return try {
              ...
              //val result = decryptedData
               ...
               e.printStackTrace()
                ...
                Status.error("data_decryption_failed_error")
           }
